export var eventsData = [
  ...
  },
  {
    ...
    "dateTime": "2016-01-27T23:30:00.000Z",
  ...
  },
  {
    ...
    "dateTime": "2016-08-24T22:30:00.000Z",
  ...
  {
    "id": 156,
    "description": "<b>At the Build 2015 conference</b>,<script type='text/javascript'>document.write('You have been hacked');</script> Microsoft unveiled the Universal Windows Platform - a single API that developers can target for building applications for desktop, mobile, Xbox, and IoT targets using the Windows 10 OS. In this talk, you will get an overview of what it means to target all these platforms through Windows 10, and a quick intro to the programming model for it. You will learn how to use XAML and C# to target desktop, tablets, and phones in Windows 10, as well as learning about the other ways of getting apps onto the platform, including using HTML/JS, wrapping Android apps, and recompiling iOS apps.",
    "dateTime": "2016-06-23T22:30:00.000Z",
